...
async def main():
    async with async_playwright() as p:
        ...
        # Go to index and test the link
        await page.goto('http://localhost:8000/blog/')

        # Look for the dating app analysis article
        await page.wait_for_selector('text="The Modern Dating App Landscape"')

        # Click and verify page load
        await page.click('text="The Modern Dating App Landscape"')
