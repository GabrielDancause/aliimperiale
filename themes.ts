export const themes = {
  ...
  brutalism: {
    ...
    links_button: 'bg-black border-2 border-white p-4 cursor-pointer transition-all duration-100 hover:bg-white group-hover:text-center hover:text-black group',
